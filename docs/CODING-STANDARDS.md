...
|---|---|
| **VIEW** | `artifacts/json-explorer/src/components/**`, `artifacts/*/src/components/**` |
| **CONTROLLER** | `artifacts/*/src/hooks/**`, `artifacts/api-server/src/routes/**`, `artifacts/api-server/src/middlewares/**` |
| **STATE** | `artifacts/json-explorer/src/store/**` |
| **PURE** | `artifacts/*/src/lib/**` |
| **PURE-CORE** | *(unmapped — promote the hottest `lib/` subtrees when they earn the 100-line limit)* |
| **DATA** | *(unmapped — no code-free data layer yet)* |
